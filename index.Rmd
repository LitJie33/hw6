...
library(readr)
books <- read.csv("C:/Users/LIT JIE/OneDrive/Desktop/hw6/mydata.csv")
books
...
# 請務必印出圖片
library(ggplot2)
ggplot(data = books, aes(x = Reviews, y = Year, colour = User.Rating))+
  geom_point()+ 
  geom_smooth()+ 
  facet_wrap(~Genre)
...
suv <- if_else(mpg$class == "suv","TRUE","FALSE")

library(ggplot2)
ggplot(data = mpg, mapping = aes(displ, hwy)) +
  geom_point(aes(colour = suv)) +
  geom_smooth() +
